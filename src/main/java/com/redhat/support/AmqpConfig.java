...
public class AmqpConfig {
    ...
    private org.apache.qpid.jms.JmsConnectionFactory amqpConnectionFactory() {
    ...
    public AMQPComponent amqpComponent() {
        ...
        amqp.setConnectionFactory(jmsPoolConnectionFactory());
        amqp.setCacheLevelName("CACHE_CONSUMER");
        amqp.setTransacted(true);
        return amqp;
    }
